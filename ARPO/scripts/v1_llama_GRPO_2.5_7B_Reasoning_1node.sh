...
PROJECT_NAME="llama7BInstruct" # Modify experiment group
EXPERIMENT_NAME="grpo" # Modify experiment name
...
ACTOR_MODEL_PATH="meta-llama/Llama-3.1-8B-Instruct"
...
SEARCH_CACHE_PATH="${ABSOLUTE_PATH}/search_cache/search_cache_updated_llama_grpo_7B.json" # Modify
...
# ============================ Path Configuration ============================
# Save path
CHECKPOINT_DIR="/scratch/project/prj-02-llm-reasoning-shakkottai/saratb/RFPP/Llama7B-Instruct"
