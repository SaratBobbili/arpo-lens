...
EXPERIMENT_NAME="echo3B_c5_maxent_v1" # validator profile c5 (all-HL); strategy=maxentropy_rl
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_new_v1_maxent.json" # Per-variant cache; isolates from other ECHO variants
