...
EXPERIMENT_NAME="echo3B_c2_ll_hl" # validator profile c2 (c1 + non-initial <select> pulled up to HL), phase_order=[low_level, high_level]
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_new_v2_ll_hl.json" # Per-variant cache for v2 with phase_order=[low_level, high_level]
