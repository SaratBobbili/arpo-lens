...
EXPERIMENT_NAME="echo3B_c3_ll_hl" # validator profile c3 (c1 + <search>/<python> payloads pulled up to HL), phase_order=[low_level, high_level]
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_new_v3_ll_hl.json" # Per-variant cache for v3 with phase_order=[low_level, high_level]
