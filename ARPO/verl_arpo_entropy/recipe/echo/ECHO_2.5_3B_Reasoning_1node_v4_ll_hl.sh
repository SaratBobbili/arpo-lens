...
EXPERIMENT_NAME="echo3B_c4_ll_hl" # validator profile c4 (only <think>/<answer> HL; first_select + select + search + python LL), phase_order=[low_level, high_level]
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_new_v4_ll_hl.json" # Per-variant cache for v4 with phase_order=[low_level, high_level]
