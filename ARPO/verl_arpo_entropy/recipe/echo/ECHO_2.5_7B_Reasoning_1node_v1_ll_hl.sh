...
EXPERIMENT_NAME="echo7BInstruct_r2" # validator profile c1 (plan/reason/answer HL; tool choice + payload LL), phase_order=[low_level, high_level]
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/checkpoints/Qwen2.5-7B-Instruct"
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_echo_7B.json" # Per-variant cache for v1 with phase_order=[low_level, high_level]
