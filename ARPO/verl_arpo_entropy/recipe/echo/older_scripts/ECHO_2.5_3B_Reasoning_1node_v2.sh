...
EXPERIMENT_NAME="echo3B_c2_hl_ll_entropy_hybrid" # validator profile c2 (c1 + non-initial <select> pulled up to HL), phase_order=[high_level, low_level]
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_new_v2.json" # Per-variant cache for v2 with phase_order=[high_level, low_level]
