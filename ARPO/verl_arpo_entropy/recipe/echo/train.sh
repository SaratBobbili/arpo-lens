...
ARGS=(
    ...
    actor_rollout_ref.actor.use_sign_cond_clip="${USE_SIGN_COND_CLIP:-false}"
    ...
    "reward_model.phase_rewards.high_level.entropy.reduction=${HL_ENTROPY_REDUCTION:-sum}"
    "reward_model.phase_rewards.low_level.entropy.reduction=${LL_ENTROPY_REDUCTION:-mean}"
    "reward_model.phase_rewards.high_level.entropy.scale=${HL_ENTROPY_SCALE:-1.0}"
    "reward_model.phase_rewards.low_level.entropy.scale=${LL_ENTROPY_SCALE:-1.0}"
    "reward_model.phase_rewards.high_level.entropy.normalize=${HL_ENTROPY_NORMALIZE:-false}"
    "reward_model.phase_rewards.low_level.entropy.normalize=${LL_ENTROPY_NORMALIZE:-false}"
    "reward_model.phase_rewards.high_level.entropy.clamp_min=${HL_ENTROPY_CLAMP_MIN:-null}"
    "reward_model.phase_rewards.low_level.entropy.clamp_min=${LL_ENTROPY_CLAMP_MIN:-null}"
    "reward_model.phase_rewards.high_level.entropy.clamp_max=${HL_ENTROPY_CLAMP_MAX:-null}"
    "reward_model.phase_rewards.low_level.entropy.clamp_max=${LL_ENTROPY_CLAMP_MAX:-null}"
    "reward_model.phase_rewards.high_level.entropy.bad_format_penalty=${HL_BAD_FORMAT_PENALTY:-0.0}"
    "reward_model.phase_rewards.low_level.entropy.bad_format_penalty=${LL_BAD_FORMAT_PENALTY:-0.0}"
    "reward_model.phase_rewards.high_level.entropy.no_tool_penalty=${HL_NO_TOOL_PENALTY:-null}"
    "reward_model.phase_rewards.low_level.entropy.no_tool_penalty=${LL_NO_TOOL_PENALTY:-null}"
    "reward_model.phase_rewards.high_level.entropy.band.enable=${HL_ENTROPY_BAND_ENABLE:-false}"
    "reward_model.phase_rewards.low_level.entropy.band.enable=${LL_ENTROPY_BAND_ENABLE:-false}"
    "reward_model.phase_rewards.high_level.entropy.band.epsilon_low=${HL_ENTROPY_BAND_EPSILON_LOW:-0.2}"
    "reward_model.phase_rewards.low_level.entropy.band.epsilon_low=${LL_ENTROPY_BAND_EPSILON_LOW:-0.2}"
    "reward_model.phase_rewards.high_level.entropy.band.epsilon_high=${HL_ENTROPY_BAND_EPSILON_HIGH:-0.2}"
    "reward_model.phase_rewards.low_level.entropy.band.epsilon_high=${LL_ENTROPY_BAND_EPSILON_HIGH:-0.2}"
    "reward_model.phase_rewards.high_level.entropy.band.h_floor=${HL_ENTROPY_BAND_H_FLOOR:-1.0e-4}"
    "reward_model.phase_rewards.low_level.entropy.band.h_floor=${LL_ENTROPY_BAND_H_FLOOR:-1.0e-4}"
    "reward_model.phase_rewards.high_level.entropy.band.warmup_steps=${HL_ENTROPY_BAND_WARMUP_STEPS:-1}"
    "reward_model.phase_rewards.low_level.entropy.band.warmup_steps=${LL_ENTROPY_BAND_WARMUP_STEPS:-1}"
    "reward_model.phase_rewards.high_level.max_entropy.alpha=${HL_MAX_ENTROPY_ALPHA:-0.1}"
    "reward_model.phase_rewards.low_level.max_entropy.alpha=${LL_MAX_ENTROPY_ALPHA:-0.1}"
    "reward_model.phase_rewards.high_level.max_entropy.mask_key=${HL_MAX_ENTROPY_MASK_KEY:-tool_loss_mask}"
    "reward_model.phase_rewards.low_level.max_entropy.mask_key=${LL_MAX_ENTROPY_MASK_KEY:-tool_loss_mask}"
    "reward_model.phase_rewards.high_level.max_entropy.reduction=${HL_MAX_ENTROPY_REDUCTION:-mean}"
    "reward_model.phase_rewards.low_level.max_entropy.reduction=${LL_MAX_ENTROPY_REDUCTION:-mean}"
    "reward_model.phase_rewards.high_level.max_entropy.normalize=${HL_MAX_ENTROPY_NORMALIZE:-true}"
    "reward_model.phase_rewards.low_level.max_entropy.normalize=${LL_MAX_ENTROPY_NORMALIZE:-true}"
