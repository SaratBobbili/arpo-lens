...
ARGS=(
    ...
    "reward_model.phase_rewards.low_level.entropy.bad_format_penalty=${LL_BAD_FORMAT_PENALTY:-0}"
    "reward_model.phase_rewards.low_level.entropy.no_tool_penalty=${LL_NO_TOOL_PENALTY:-0.0}"
