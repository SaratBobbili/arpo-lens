...
Edit the CONFIG block below and run:
    python ECHO/training/analysis/plot_convergence_3B.py
"""
...
ALGORITHMS = {
    "ECHO": {
        ...
        "step0_value": 0.3979629629629629,  # TODO: set float, e.g. 0.352
    },
    "ARPO": {
        "label": "ARPO",
        "color": "#888888",
        ...
        "step0_value": 0.383,  # TODO: set float, e.g. 0.341
    },
    "GRPO": {
    "label": "GRPO",
    "color": "#ff7f0e",
    "marker": "^",
    "wandb_dir": Path(
        "/scratch/project/prj-02-llm-reasoning-shakkottai/saratb/GRPO/"
        "Qwen3B-Instruct/checkpoints/grpo/wandb"
    ),
    "step0_value": 0.3,  # TODO: set float, e.g. 0.341
    }
}
