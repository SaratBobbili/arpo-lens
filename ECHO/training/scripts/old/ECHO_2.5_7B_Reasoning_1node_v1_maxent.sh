...
EXPERIMENT_NAME="echo7B_maxentRL" # validator profile c5 (all-HL); strategy=maxentropy_rl
...
SEARCH_CACHE_PATH="${ARPO_ROOT}/search_cache/search_cache_echo_7B_maxentRL.json" # Per-variant cache; isolates from other ECHO variants
