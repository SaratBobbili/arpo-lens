...
#
# Exact hypergradient, K = 1.  sbatch scripts/sbatch_exact_k1.sh
#
...
export EXPERIMENT_NAME=echo7B_sft5e8_exact_k1
export BASE_PROFILE=training_config/config_exact_k1.yaml
