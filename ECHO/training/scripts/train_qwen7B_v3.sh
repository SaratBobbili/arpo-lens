...
# lr 3e-8 for 1 epoch. NOTE: that 3e-8 is the *SFT* learning rate, not the RL one -- the RL
...
#   bash train_qwen7B_v3.sh
#   EXPERIMENT_NAME=my_run bash train_qwen7B_v3.sh hl_lr=5e-7 ll_num_iters=40
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-echo7B_sft3e8_rl1e-6-r4}"
