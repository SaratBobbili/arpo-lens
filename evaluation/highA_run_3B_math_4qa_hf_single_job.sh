...
RAW_ACTOR_CHECKPOINT_PATH="${CHECKPOINT_DIR}/checkpoints/echo3B-rerun-entropy-allhigh/global_step_5/actor"
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/checkpoints/echo3B-rerun-entropy-allhigh/global_step_5/hf"
