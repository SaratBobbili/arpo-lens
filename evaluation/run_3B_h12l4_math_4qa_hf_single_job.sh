...
RAW_ACTOR_CHECKPOINT_PATH="${CHECKPOINT_DIR}/checkpoints/echo3B-high12-low4/global_step_10/actor"
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/checkpoints/echo3B-high12-low4/global_step_10/hf"
