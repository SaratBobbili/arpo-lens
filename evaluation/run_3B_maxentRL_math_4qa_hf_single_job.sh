...
RAW_ACTOR_CHECKPOINT_PATH="${CHECKPOINT_DIR}/checkpoint_snapshots/echo3B_maxentRL-r2/global_step_100/actor"
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/checkpoint_snapshots/echo3B_maxentRL-r2/global_step_100/hf"
REASON_MODEL_PATH="${ACTOR_MODEL_PATH}"
# Served model alias for reasoning endpoints; must match infer DEFAULT_MODEL.
REASON_MODEL_NAME="Qwen2.5-3B-Instruct-maxentRL-r2"
