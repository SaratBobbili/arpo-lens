...
RAW_ACTOR_CHECKPOINT_PATH="${CHECKPOINT_DIR}/checkpoints/echo7B-rerun-entropy-coeff0-penalty-0.1/global_step_40/actor"
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/checkpoints/echo7B-rerun-entropy-coeff0-penalty-0.1/global_step_40/hf"
...
TRAINING_RECIPE_PATH="${SCRIPT_DIR}/../ECHO/training/scripts/old/ECHO_2.5_7B_Reasoning_1node_v1_ll_hl.sh"
