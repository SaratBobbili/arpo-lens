...
ARPO_ROOT="/scratch/user/saratb_tamu.edu/research/arpo-lens/ARPO"
RAW_ACTOR_CHECKPOINT_PATH="${ARPO_ROOT}/checkpoints/echo3B_c1_ll_hl/global_step_156/actor"
...
ACTOR_MODEL_PATH="${ARPO_ROOT}/checkpoints/echo3B_c1_ll_hl/global_step_156/hf"
...
OUTPUT_PATH="outputs/hf_math_4qa_bing/${CUSTOM_RUN_TAG}/${DATASET_GROUP}${RUN_TAG:+_$RUN_TAG}"
