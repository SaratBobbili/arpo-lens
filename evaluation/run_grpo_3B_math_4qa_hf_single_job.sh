...
CHECKPOINT_DIR="/scratch/project/prj-02-llm-reasoning-shakkottai/saratb/GRPO"
...
RAW_ACTOR_CHECKPOINT_PATH="${CHECKPOINT_DIR}/Qwen3B-Instruct/checkpoints/grpo/global_step_40/actor"
...
ACTOR_MODEL_PATH="${CHECKPOINT_DIR}/Qwen3B-Instruct/checkpoints/grpo/global_step_40/hf"
