...
from .tools.search_tool import BingSearchTool
...
class AsyncInference:
    ...
    def __init__(self, args):
        ...
        stop_strings = self.prompt_manager.get_stop_strings() or None
    ...
    async def run(self):
        for dataloader in self.data_loaders:
            ...
            os.makedirs(
                os.path.join(self.args.output_path, "outputs"), exist_ok=True
            )
            ...
            print(
                f"Processed {dataset_name}, save results to {output_file}"
            )
